...
def test_store_overwrite_with_different_type_replaces_stale_file(client):
    _upload(client, "avatar", "1", filename="a.png", data=b"png-bytes")
    _upload(client, "avatar", "1", filename="a.jpg", data=b"jpg-bytes")

    resp = client.get("/asset/avatar/1")
